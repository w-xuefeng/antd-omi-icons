...
export default class CopyrightCircleTwoTone extends OmiComponent<AntdIconProps> {
  ...
  render(props: Omi.OmiProps<AntdIconProps>) {
    return <o-antd-icon {...rmIEFP(props)} icon={CopyrightCircleTwoToneSvg} />;
  };
}
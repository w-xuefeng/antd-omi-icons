...
export default class DislikeTwoTone extends OmiComponent<AntdIconProps> {
  ...
  render(props: Omi.OmiProps<AntdIconProps>) {
    return <o-antd-icon {...rmIEFP(props)} icon={DislikeTwoToneSvg} />;
  };
}
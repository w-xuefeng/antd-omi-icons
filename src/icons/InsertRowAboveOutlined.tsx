...
export default class InsertRowAboveOutlined extends OmiComponent<AntdIconProps> {
  ...
  render(props: Omi.RenderableProps<AntdIconProps>) {
    return <o-antd-icon {...props} icon={InsertRowAboveOutlinedSvg} />;
  };
}
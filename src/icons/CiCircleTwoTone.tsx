...
export default class CiCircleTwoTone extends OmiComponent<AntdIconProps> {
  ...
  render(props: Omi.OmiProps<AntdIconProps>) {
    return <o-antd-icon {...rmIEFP(props)} icon={CiCircleTwoToneSvg} />;
  };
}
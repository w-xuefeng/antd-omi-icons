...
export default class StopTwoTone extends OmiComponent<AntdIconProps> {
  ...
  render(props: Omi.RenderableProps<AntdIconProps>) {
    return <o-antd-icon {...rmIEFP(props)} icon={StopTwoToneSvg} />;
  };
}
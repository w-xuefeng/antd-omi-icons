...
export default class DollarCircleOutlined extends OmiComponent<AntdIconProps> {
  ...
  render(props: Omi.RenderableProps<AntdIconProps>) {
    return <o-antd-icon {...rmIEFP(props)} icon={DollarCircleOutlinedSvg} />;
  };
}